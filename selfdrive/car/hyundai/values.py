...
ELEC_VEH = set([CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV,]) #KIA_NIRO_HEV is a hybrid, but seems to use E_EMS11 for gas

HYBRID_VEH = set([CAR.KIA_OPTIMA_HEV, CAR.SONATA_HEV_2019, CAR.SONATA_HEV, CAR.IONIQ_HEV, CAR.KIA_CADENZA_HEV, CAR.GRANDEUR_HEV, CAR.KONA_HEV])
