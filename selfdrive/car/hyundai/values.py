...
class CAR:
  ...
  KIA_NIRO_HEV = "KIA NIRO HEV 2020"
...
FW_VERSIONS = {
  ...
  CAR.KIA_NIRO_HEV: {
    (Ecu.transmission, 0x7E1, None): [      b'\xf1\x816U3J8051\x00\x00\xf1\x006U3H1_C2\x00\x006U3J8051\x00\x00HDETG16UL3\x00\x00\x00\x00'
    ],
    (Ecu.fwdRadar, 0x7D0, None): [
      b'\xf1\x00DEhe SCC F-CUP      1.00 1.02 99110-G5000         '
    ],
    (Ecu.fwdCamera, 0x7C4, None): [
      b'\xf1\x00DEH MFC  AT EUR LHD 1.00 1.05 99211-G5000 190826'
    ],
    (Ecu.engine, 0x7E0, None): [
...
FEATURES = {
  ...
  "use_fca": set([CAR.SONATA, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KIA_STINGER, CAR.IONIQ, CAR.IONIQ_EV_2020, CAR.KONA_EV, CAR.KIA_FORTE, CAR.KIA_NIRO_EV,CAR.KIA_NIRO_HEV, CAR.PALISADE, CAR.GENESIS_G70, CAR.KONA, CAR.SANTA_FE, CAR.KIA_SELTOS]),
...
EV_HYBRID = set([CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV])
